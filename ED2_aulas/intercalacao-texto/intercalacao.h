...
// num_p: numero de particoes a serem intercaladas
// nome_particoes: lista encadeada com nomes das particoes de entrada
void intercalacao_arv_vencedores(char *nome_arquivo_saida, int num_p, TNomes *nome_particoes);
...
void intercalacao_otima(char *nome_arquivo_saida, int num_p, TNomes *nome_particoes, int f);
